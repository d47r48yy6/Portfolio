//Will Add testimonial section later //
export const navItems = [
  ...
  export const gridItems = [
    {
      id: 1,
      title: "Crafting spells of creativity for Clients, weaving dreams into reality. ",
      description: "",
    ...
    {
      id: 2,
      title: "Time zones fade when wizardry connects.",
      description: "",
    ...
    {
      id: 4,
      title: "Wizardry meets technology, in the hands of passion.",
      description: "",
    ...
    {
      id: 5,
      title: "Currently building a UPPCL(PMS) Web application",
  ...
  export const projects = [
    ...
    {
      id: 4,
      title: "Smart-Contract Legal Aggrements",
      des: "Based On BlockChain Concept",
      img: "/p4.svg",
